...
--SELECT count(*) FROM dwr_dim.dim_org_sys_dept_d  12
--update dwi_bm.dwi_bm_sys_dept_info set dw_creation_date = '2021-05-14 16:11:29' where dept_id = '102'
--SELECT * FROM dwi_bm.dwi_bm_sys_dept_info
--select * from dwr_dim.dim_org_sys_dept_d