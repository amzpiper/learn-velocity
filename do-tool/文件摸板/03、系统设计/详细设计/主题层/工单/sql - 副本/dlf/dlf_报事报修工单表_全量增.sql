...
BEGIN
    ...
    SELECT
        ...
        c.evaluate_level AS evaluate_level,
        c.description AS evaluate_description,
        '${job_name}',
        u_current_day,
        '${job_name}',
        '${job_plan_time}',
    ...
    left join dwi_bm.dwi_bm_t_evaluate_info c on a.order_id = c.order_id;
