package com.dotool.cloud.dlf.tool;
			...
			for (int i = 1; i <= last; i++) {
				...
				for (int b = 2; b <= sheet.getLastRowNum(); b++) {
					...
					if (fromName == null || fromName.equals("")) {
						...
						mappingTable.setFromSechma(fromSechma);
						mappingTable.setFromTableName(fromTableName);
						mappingTable.setFromTableNameDes(fromTableNameDes);
					}
