...
public class CreateDLFScriptZip {
...
//		File file = new File("E:\\cc_project\\nwim\\SmartPark\\广东省二医\\03、系统设计\\详细设计\\主题\\医疗");
		File file = new File("E:\\cc_project\\nwim\\SmartPark\\广东省二医\\03、系统设计\\详细设计\\主题\\组织");
		...
		for(File pf : getFileByFileName(file, "dlf")) {
			...
			for(File f : pf.listFiles()) {
				...
				while(matcher.find()) {
					...
					ZipUtils.stringToZip("scripts/dws/dwr/"+matcher.group("g1")+"/"+ scriptName +".script", zos, sb.toString());
