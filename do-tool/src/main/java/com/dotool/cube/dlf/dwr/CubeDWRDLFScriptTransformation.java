package com.dotool.cube.dlf.dwr;
...
public class CubeDWRDLFScriptTransformation {

	public static void main(String[] args) throws Exception {
//		File file = new File("E:\\cc_project\\nwim\\SmartPark\\广东省二医\\03、系统设计\\详细设计\\主题\\医疗");
//		File file = new File("E:\\cc_project\\nwim\\SmartPark\\广东省二医\\03、系统设计\\详细设计\\主题\\工单");
		File file = new File("E:\\cc_project\\nwim\\SmartPark\\广东省二医\\03、系统设计\\详细设计\\主题\\能耗");
...
//		createDwrScriptInit(file);
	...
	public static void createDwrScript(File file) throws Exception {
		for(File pf : getFileByFileName(file, "dlf")) {
			System.out.println(pf);
			ZipOutputStream zos = new ZipOutputStream(new FileOutputStream(pf.getParent() + "\\cube_dwr_"+pf.getParentFile().getParentFile().getName()+"_dlf.zip"),Charset.forName("utf8"));
			for(File f : pf.listFiles()) {
...
//					sb.append("    \"configuration\":{},\n");
					sb.append("    \"connectionName\":\"do_data_warehouse\",\n");
