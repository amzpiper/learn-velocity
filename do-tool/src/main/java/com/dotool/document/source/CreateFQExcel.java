package com.dotool.document.source;
...
//	public static String fileName = "E:\\cc_project\\nwim\\SmartPark\\重庆璧山\\tmp\\20200520\\重庆璧山项目数据字典整理+样例数据05221127-更新日期20200630_V1.0.xlsx";
		...
		try {
			...
			for (Table table : tableList) {
			    ...
			    for (Field field : table.getFieldList()) {
					...
					rr.createCell(4).setCellValue(lengthStr);
