package com.excel.cube.createtable.dm;
 ...
 * 生成创建表的sql
 */
public class CubeCreateDMSQL {
	public static void main(String[] args) throws Exception {
		
		
		File file = new File("E:\\SVN仓库\\广东省二医\\03、系统设计\\详细设计\\专题\\设备");
	...
	public static void createDWISQL(String filePath) throws Exception {
		...
		Pattern pp = Pattern.compile("DM-(?<name>\\W+?)-");
		...
		//创建包含分区键的sql
		File file = new File(p + "/sql/dm_"+name+"_ddl_分区.txt");
